...
import {
  ...
  PINKY_OFFSET_X, PINKY_BASE_HEIGHT, PINKY_MID_HEIGHT, PINKY_WIDTH, PINKY_TIP_HEIGHT, PINKY_DEPTH, ARM_UPPER_WIDTH, ARM_UPPER_DEPTH, ARM_LOWER_WIDTH, ARM_LOWER_DEPTH
...
const headVolume = new Volume({ width: HEAD_WIDTH, height: HEAD_HEIGHT, depth: HEAD_DEPTH, translationY: HEAD_HEIGHT / 2, color: 'magenta' })
const neckVolume = new Volume({ width: NECK_WIDTH, height: NECK_HEIGHT, depth: NECK_DEPTH, translationY: NECK_HEIGHT / 2, color: 'cyan' })
const chestVolume = new Volume({ width: CHEST_WIDTH, height: CHEST_HEIGHT, depth: CHEST_DEPTH, translationY: CHEST_HEIGHT / 2, color: 'magenta' })
const absVolume = new Volume({ width: ABDOMEN_WIDTH, height: ABDOMEN_HEIGHT, depth: ABDOMEN_DEPTH, translationY: ABDOMEN_HEIGHT / 2, color: 'cyan' })
const waistVolume = new Volume({ width: WAIST_WIDTH, height: WAIST_HEIGHT, depth: WAIST_DEPTH, translationY: -WAIST_HEIGHT / 2, color: 'lime' })
const upperLegVolume = new Volume({ width: LEG_UPPER_WIDTH, height: LEG_UPPER_HEIGHT, depth: LEG_UPPER_DEPTH, translationY: -LEG_UPPER_HEIGHT / 2, color: 'red' })
const lowerLegVolume = new Volume({ width: LEG_LOWER_WIDTH, height: LEG_LOWER_HEIGHT, depth: LEG_LOWER_DEPTH, translationY: -LEG_LOWER_HEIGHT / 2, color: 'cyan' })
const footVolume = new Volume({ width: FOOT_WIDTH, height: FOOT_HEIGHT, depth: FOOT_DEPTH, translationY: -FOOT_HEIGHT / 2, color: 'yellow' })
const toesVolume = new Volume({ width: TOES_WIDTH, height: TOES_HEIGHT, depth: TOES_DEPTH, translationY: TOES_HEIGHT / 2, translationZ: TOES_DEPTH / 2, color: 'yellow' })
const upperArmVolume = new Volume({ width: ARM_UPPER_WIDTH, height: ARM_UPPER_HEIGHT, depth: ARM_UPPER_DEPTH, translationY: -ARM_UPPER_HEIGHT / 2, color: 'red' })
const lowerArmVolume = new Volume({ width: ARM_LOWER_WIDTH, height: ARM_LOWER_HEIGHT, depth: ARM_LOWER_DEPTH, translationY: -ARM_LOWER_HEIGHT / 2, color: 'cyan' })
const palmVolume = new Volume({ width: PALM_WIDTH, height: PALM_HEIGHT, depth: PALM_DEPTH, translationY: -PALM_HEIGHT / 2, color: 'yellow' })
const thumbBaseVolume = new Volume({ width: THUMB_WIDTH, height: THUMB_BASE_HEIGHT, depth: THUMB_DEPTH, translationY: -THUMB_BASE_HEIGHT / 2, color: 'yellow' })
const thumbMidVolume = new Volume({ width: THUMB_WIDTH, height: THUMB_MID_HEIGHT, depth: THUMB_DEPTH, translationY: -THUMB_MID_HEIGHT / 2, color: 'yellow' })
const thumbTipVolume = new Volume({ width: THUMB_WIDTH, height: THUMB_TIP_HEIGHT, depth: THUMB_DEPTH, translationY: -THUMB_TIP_HEIGHT / 2, color: 'yellow' })
const indexBaseVolume = new Volume({ width: INDEX_WIDTH, height: INDEX_BASE_HEIGHT, depth: INDEX_DEPTH, translationY: -INDEX_BASE_HEIGHT / 2, color: 'yellow' })
const indexMidVolume = new Volume({ width: INDEX_WIDTH, height: INDEX_MID_HEIGHT, depth: INDEX_DEPTH, translationY: -INDEX_MID_HEIGHT / 2, color: 'yellow' })
const indexTipVolume = new Volume({ width: INDEX_WIDTH, height: INDEX_TIP_HEIGHT, depth: INDEX_DEPTH, translationY: -INDEX_TIP_HEIGHT / 2, color: 'yellow' })
const middleBaseVolume = new Volume({ width: MIDDLE_WIDTH, height: MIDDLE_BASE_HEIGHT, depth: MIDDLE_DEPTH, translationY: -MIDDLE_BASE_HEIGHT / 2, color: 'yellow' })
const middleMidVolume = new Volume({ width: MIDDLE_WIDTH, height: MIDDLE_MID_HEIGHT, depth: MIDDLE_DEPTH, translationY: -MIDDLE_MID_HEIGHT / 2, color: 'yellow' })
const middleTipVolume = new Volume({ width: MIDDLE_WIDTH, height: MIDDLE_TIP_HEIGHT, depth: MIDDLE_DEPTH, translationY: -MIDDLE_TIP_HEIGHT / 2, color: 'yellow' })
const ringBaseVolume = new Volume({ width: RING_WIDTH, height: RING_BASE_HEIGHT, depth: RING_DEPTH, translationY: -RING_BASE_HEIGHT / 2, color: 'yellow' })
const ringMidVolume = new Volume({ width: RING_WIDTH, height: RING_MID_HEIGHT, depth: RING_DEPTH, translationY: -RING_MID_HEIGHT / 2, color: 'yellow' })
const ringTipVolume = new Volume({ width: RING_WIDTH, height: RING_TIP_HEIGHT, depth: RING_DEPTH, translationY: -RING_TIP_HEIGHT / 2, color: 'yellow' })
const pinkyBaseVolume = new Volume({ width: PINKY_WIDTH, height: PINKY_BASE_HEIGHT, depth: PINKY_DEPTH, translationY: -PINKY_BASE_HEIGHT / 2, color: 'yellow' })
const pinkyMidVolume = new Volume({ width: PINKY_WIDTH, height: PINKY_MID_HEIGHT, depth: PINKY_DEPTH, translationY: -PINKY_MID_HEIGHT / 2, color: 'yellow' })
const pinkyTipVolume = new Volume({ width: PINKY_WIDTH, height: PINKY_TIP_HEIGHT, depth: PINKY_DEPTH, translationY: -PINKY_TIP_HEIGHT / 2, color: 'yellow' })
